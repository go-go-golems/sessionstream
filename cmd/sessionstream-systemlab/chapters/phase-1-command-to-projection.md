...
- `cmd/sessionstream-systemlab/lab_environment.go` — Phase 1 lab setup
- `cmd/sessionstream-systemlab/static/partials/phase1.html` — page layout
- `cmd/sessionstream-systemlab/static/js/pages/phase1.js` — page behavior
