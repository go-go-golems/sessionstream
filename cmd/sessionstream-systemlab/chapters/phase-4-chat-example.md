...
> The chat example is a consumer of `sessionstream`, not part of `sessionstream`.

```text
sessionstream          = generic substrate
...
- The chat example is a consumer of `sessionstream`, not part of it. Chat logic stays in example code.
...
- `sessionstream/examples/chat/` — chat example package

### Systemlab files

- `cmd/sessionstream-systemlab/static/partials/phase4.html`
